...
const Footer = () => {
    return(
        <div className={styles.footermain}>
            ...
            <div>
                <div style={{fontSize:"13px", color:"grey",marginLeft:"55px",marginRight:"55px",}}>
             ...
             <div style={{fontSize:"13px" , color:"grey", marginLeft:"55px",marginRight:"55px",marginTop:"15px"}}>
            ...
            <div style={{display:"flex",marginLeft:"105px",mqrginRight:"55px",marginTop:"15px"}}>
              {
                  ["NSE","BSE","MCX"," Terms & Conditions", "Policies & Procedures","Privacy POlicy", "Disclosure","For Investor's Attention"].map((item) =>{
                      return(
                          <div style={{fontSize:"13px", color:"grey", marginLeft:"85px"}}>{item}</div>
                      )
                  })
              }
          </div>
